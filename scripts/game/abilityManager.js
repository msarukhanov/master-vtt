const abilityManager = {
    ...
    activate(ctx, caster, tq, tr, ability) {
        if (caster.mp < (ability.manacost || 0)) return alert("Недостаточно маны!");
        ...
        targets.forEach(t => {
            ...
            const targetContent = characterManager.getCharacterById(cell.content.unit);
